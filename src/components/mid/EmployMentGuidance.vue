...
<script lang="ts" setup name="EmployMentGuidance">
  import User from './EmployMentGuidance/User.vue';
  import Chat from './EmployMentGuidance/Chat.vue';
  import Question from './EmployMentGuidance/Question.vue';
  import Annotate from './EmployMentGuidance/Annotate.vue';
  import FirstChat from './EmployMentGuidance/FirstChat.vue';
