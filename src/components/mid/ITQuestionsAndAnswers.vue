<template>
  <div class="iTQuestionsAndAnswers">
    <!-- 问题提问之后产生 -->
...
<script lang="ts" setup name="ITQuestionsAndAnswers">
  import User from './ITQuestionsAndAnswers/User.vue'
  import Chat from './ITQuestionsAndAnswers/Chat.vue'
  import Question from './ITQuestionsAndAnswers/Question.vue'
  import Annotate from './ITQuestionsAndAnswers/Annotate.vue'
